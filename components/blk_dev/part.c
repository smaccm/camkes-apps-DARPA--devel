 ...
 * - shared buffer with mmc component (mmc_block_dev)
 * ...
 * }
 *
 *
...
struct block_drvr {
	char *name;
	block_dev_desc_t* (*get_dev)(int dev); //this can be changed into block_dev_desc_t* block_dev;
};
...
static const struct block_drvr block_drvr[] = {
	...
	{ .name = "mmc", .get_dev = mmc_get_dev, }, //mmc_get_dev can be replaced with mmc_block_dev
#endif
